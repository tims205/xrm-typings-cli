...
.requiredOption('-n, --namespace <string>', 'Top level namespace for d.ts file')
...
program
    ...
    .option('-p --publisherPrefix <string>', 'Generate constants for all entities with this Publisher Prefix')
